...
class TelaPrincipal(Screen):
    ...
    def reposicionar_elementos(self, *args):
        ...
        self.d4.pos = (0, altura / 4 + 325)
        self.d6.pos = (0, altura / 4 + 225)
        self.d10.pos = (150, altura / 4 + 225)
        self.d20.pos = (150, altura / 4 + 325)
        self.cura.pos = (150, altura / 4 - 75)
        self.dano.pos = (0, altura / 4 - 75)
        self.up.pos = (0, 100)
        self.down.pos = (0, 0)
        ...
        self.d10.size = (largura/6, altura / 12)
        self.d20.size = (largura/6, altura / 12)
        self.cura.size = (largura/6, altura / 12)
        self.dano.size = (largura/6, altura / 12)
        self.up.size = (largura/6, altura / 12)
        self.down.size = (largura/6, altura / 12)
