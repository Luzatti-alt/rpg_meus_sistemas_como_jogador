...
class TelaPrincipal(Screen):
    ...
    def reposicionar_elementos(self, *args):
        ...
        #size
        self.efeitos.size = (0, altura / 2 + 125)
        self.d4.size = (0, altura / 2 + 325)
        self.d6.size = (0, altura / 2 + 225)
        self.d10.size = (150, altura / 2 + 225)
        self.d20.size = (150, altura / 2 + 325)
        self.cura.size = (150, altura / 2 - 75)
        self.dano.size = (0, altura / 2 - 75)
        self.up.size = (0, 100)
        self.down.size = (0, 0)
        self.esquerda.size = (150, 0)
        self.direita.size = (150, 100)
        self.aplicar_efeito.size = (0, altura / 2 + 25)
        self.efeitos.size = (0, altura / 2 + 125)
