...
class TelaPrincipal(Screen):
    ...
    def reposicionar_elementos(self, *args):
        ...
        #size
        self.efeitos.size = (largura/6, altura /6)
        self.d4.size = (largura/6, altura / 6)
        self.d6.size = (largura/6, altura / 6)
        self.d10.size = (largura/6, altura / 6)
        self.d20.size = (largura/6, altura / 6)
        self.cura.size = (largura/6, altura / 6)
        self.dano.size = (largura/6, altura / 6)
        self.up.size = (largura/6, altura / 6)
        self.down.size = (largura/6, altura / 6)
        self.esquerda.size = (largura/6, altura / 6)
        self.direita.size = (largura/6, altura / 6)
        self.aplicar_efeito.size = (largura/6, altura / 6)
        self.efeitos.size = (largura/6, altura / 6)
